    ...
    if (message.hasOwnProperty('fPort') && message.hasOwnProperty('data')) {
        ...
        if (fPort == 3) {
            ...
            var payload = {
                ...
                "fPort": message.fPort,
                "Date": new Date(),
                "air_temperature": result.messages[0][0].measurementValue,
                "air_humidity": result.messages[0][1].measurementValue,
                "light_intensity": result.messages[0][2].measurementValue,
                "uv_index": result.messages[0][3].measurementValue,
                "wind_speed": result.messages[0][4].measurementValue,
